...
/*
 Package inventory implements a 'collection' of Things. It can be used as
 the inventory of a location - who and what is at that location. It can
 also be used as a literal inventory for container type objects such as
 bags, boxes and pouches.
*/
package inventory
...
/*
 ...
 However when broadcasting the message to the location you want to ommit
 the 'actor' who has the specific message.

 Note that locations implement an inventory to store what mobiles/players
 and things are present which is why this works.
*/
